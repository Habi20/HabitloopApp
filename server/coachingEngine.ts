import type { User, Habit, HabitCompletion, Streak, CoachingMessage, InsertCoachingMessage } from "@shared/schema";
...
export class AICoachingEngine {
  ...
  private generateEncouragement(trigger: CoachingTrigger, user: User): CoachingResponse {
  ...
  private generateComebackMessage(trigger: CoachingTrigger, user: User): CoachingResponse {
    return {
  ...
  private generateDailyMotivation(user: User, habits: Habit[], completions: HabitCompletion[]): CoachingResponse {
  ...
  private generateAchievementMessage(trigger: CoachingTrigger, user: User): CoachingResponse {
    return {
  ...
  private generateStruggleSupport(trigger: CoachingTrigger, user: User): CoachingResponse {
