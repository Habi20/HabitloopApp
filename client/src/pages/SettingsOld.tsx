    ...
    >
        <div className="max-w-6xl mx-auto">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Show rotating habit display</p>
                  </div>
                  <Switch
                    checked={settings.showHabitCarousel}
                    onCheckedChange={(checked) =>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Save Button - Only show for super admin */}
            {isSuperAdmin && (
        ...
        {/* Export Data Dialog - Only show for super admin */}
        {isSuperAdmin && (
        ...
        {/* Delete Account Confirmation Dialog - Only show for super admin */}
        {isSuperAdmin && (
