        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-gray-900">{completions?.length || 0}</div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-gray-900">{user.level || 1}</div>
              ...
              <div className="space-y-6">
                  ...
                  <div key={habit.id} className="flex items-center space-x-4">
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm text-gray-600">{habit.last7DaysRate}%</span>
                      </div>
                ...
                {habitStats.length === 0 && (
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p>No habits to display. Start tracking some habits to see your stats!</p>
                  </div>
                )}
              </div>
            </CardContent>
