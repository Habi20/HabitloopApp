      ...
      <main className="flex-1 p-6 lg:p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <i className={`${challenge.icon} text-xl ${challenge.color}`}></i>
                      <div>
                    ...
                    <div className="text-right">
                      <Badge variant={challenge.type === "monthly" ? "default" : "secondary"}>
                        {challenge.type}
                      </Badge>
                      <div className="text-sm text-gray-600 mt-1">{challenge.reward}</div>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
            ...
            <div className="mt-12">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Completed This Month</h2>
              
              <Card className="bg-green-50 border-green-200">
                <CardContent className="p-6 text-center">
                  <i className="fas fa-trophy text-4xl text-green-500 mb-4"></i>
                  <h3 className="font-semibold text-gray-900 mb-2">First Week Champion</h3>
                  <p className="text-gray-600 text-sm mb-3">Completed all habits for your first week</p>
