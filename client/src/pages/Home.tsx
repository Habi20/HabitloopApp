...
export default function Home() {
  ...
  const completedToday = completions?.filter(c => c.completedAt === today) || [];
  const completedHabitIds = new Set(completedToday.map(c => c.habitId));

  const todayStats = {
    completed: completedToday.length,
    total: habits?.length || 0,
    completionRate: habits?.length ? Math.round((completedToday.length / habits.length) * 100) : 0,
  };

  const currentStreak = Math.max(...(habits?.map(h => 7) || [0])); // TODO: Get from streaks table
  const longestStreak = Math.max(...(habits?.map(h => 12) || [0])); // TODO: Get from streaks table
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                <div>
                  ...
                  <p className="text-indigo-100 text-lg">You're doing great! Keep up the momentum.</p>
                </div>
          ...
          <div className="max-w-4xl mx-auto p-6 lg:p-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              <Card>
                <CardContent className="p-4">
                  ...
                  <div className="text-2xl font-bold text-gray-900">{todayStats.completed}</div>
                  <div className="text-xs text-gray-500">out of {todayStats.total} habits</div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-4">
                  ...
                  <div className="text-2xl font-bold text-gray-900">{todayStats.completionRate}%</div>
              ...
              <Card>
                <CardContent className="p-4">
                  ...
                  <div className="text-xs text-gray-500">{180 - (user.xp || 0)} more XP</div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">AI Success Predictor</h3>
              <MLPredictionCard />
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button onClick={() => setShowAddHabit(true)} className="flex items-center space-x-2">
              ...
              <div className="space-y-4">
                {habits?.map((habit) => (
                  <HabitCard
                    ...
                    onToggle={(completed) => 
                      toggleCompletionMutation.mutate({ habitId: habit.id, completed })
                    }
                ...
                {(!habits || habits.length === 0) && (
                  <Card>
                    <CardContent className="p-8 text-center text-gray-500">
                      ...
                      <p className="mb-4">Start building better habits today!</p>
