      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
          <div className="flex items-center gap-2">
            <div className={`w-2 h-2 rounded-full ${modelStatus?.trained ? 'bg-green-500' : 'bg-red-500'}`} />
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="p-3 bg-blue-50 dark:bg-blue-950 rounded">
                ...
                <div className="font-semibold text-lg">
                  {typeof trainMutation.data === 'object' && trainMutation.data && 'r2_score' in trainMutation.data 
                    ? (trainMutation.data.r2_score as number)?.toFixed(4) 
                    : 'N/A'}
                </div>
              </div>
              <div className="p-3 bg-green-50 dark:bg-green-950 rounded">
                ...
                <div className="font-semibold text-lg">
                  {trainMutation.data.features_trained || 'N/A'}
                </div>
              </div>
            </div>
