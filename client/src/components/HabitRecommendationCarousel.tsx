  ...
  const addHabitMutation = useMutation({
    mutationFn: async (recommendation: HabitRecommendation) => {
      ...
      const habitData = {
        ...
        reminderTime: recommendation.reminderTime,
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span>{currentRecommendation.targetValue} {currentRecommendation.unit}</span>
              </div>
              <div className="flex items-center space-x-2">
                <Clock className="w-4 h-4 text-gray-500" />
                <span>{currentRecommendation.reminderTime}</span>
              </div>
            </div>
            ...
            <div className="bg-purple-50 p-3 rounded-lg">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <p className="text-purple-800 text-sm mt-1">{currentRecommendation.aiReasoning}</p>
                </div>
              </div>
            </div>
