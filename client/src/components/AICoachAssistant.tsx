...
import { Brain, MessageCircle, Target, TrendingUp, Lightbulb, Calendar } from "lucide-react";
  ...
  const coachServices = [
    {
      ...
      description: "Get insights on your habit completion patterns and streak analysis",
      icon: TrendingUp,
      color: "bg-green-500",
    },
    {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-600">
            Get personalized guidance, insights, and support for your habit journey
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900">Quick Assistance</h3>
            ...
            <div className="border-t pt-4">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  {askCoachMutation.isPending ? "Getting Response..." : "Ask Coach"}
                </Button>
              </div>
            </div>
          </div>
          ...
          {/* Response Panel */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900">Coach Response</h3>
              ...
              <Card className="border-2 border-dashed border-gray-300">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600">
                    Select a service or ask a question to get personalized guidance from your AI coach.
                  </p>
                </CardContent>
              </Card>
            )}
            ...
            {habits && Array.isArray(habits) && habits.length > 0 && (
              <Card>
                <CardContent className="p-4">
                  <h4 className="font-medium text-gray-900 mb-3">Your Current Habits</h4>
