  ...
  const {
    ...
    queryFn: async () => {
      ...
      const response = await fetch(
        buildApiUrl(`ml/analytics?userId=${user?.id}`)
      );
      if (!response.ok) {
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span
              className={`text-lg font-bold ${getConsistencyColor(
        ...
        <div className="space-y-2">
          ...
          {mlAnalytics.optimalTimes.length > 0 ? (
            ...
            <div className="text-center py-2">
              <p className="text-xs text-gray-500">No habits added yet</p>
            </div>
          )}
          <p className="text-xs text-gray-500">
        ...
        <div className="space-y-2">
          ...
          {mlAnalytics.performanceCategories.length > 0 ? (
            <div className="flex flex-wrap gap-2">
              {mlAnalytics.performanceCategories.map(
            ...
            <div className="text-center py-4">
              ...
              <p className="text-xs text-gray-500">
                No habits added yet. Add your first habit to see your
                achievements!
              </p>
            </div>
          )}
