          ...
          <div className="space-y-2">
            ...
            >
              <i className={cn(
                ...
                location === "/stats" ? "text-white" : "text-gray-500 group-hover:text-primary"
              )}></i>
            ...
            >
              <i className={cn(
                ...
                location === "/habits" ? "text-white" : "text-gray-500 group-hover:text-primary"
              )}></i>
            ...
            >
              <i className={cn(
                ...
                location === "/challenges" ? "text-white" : "text-gray-500 group-hover:text-primary"
              )}></i>
