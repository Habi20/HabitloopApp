...
const GOAL_OPTIONS = [
  'Improve productivity', 'Build healthy habits', 'Learn new skills', 'Exercise regularly', 'Read more books', 'Practice mindfulness',
  'Save money', 'Social connections', 'Career development', 'Personal growth',
];
const AVATAR_STYLES = [
...
export function HabitLoopSignupModal({
  open, onClose, onSuccess, onUserCreated, autoGeneratedUserId
  ...
  const handleGoalToggle = (goal: string) => {
    setSignupFormData(prev => ({
      ...prev, goals: prev.goals.includes(goal)
    ...
    try {
      const response = await fetch(buildApiUrl('habitloop/signup'), {
        ...
        body: JSON.stringify({
          ...
          bio: signupFormData.bio, goals: signupFormData.goals,
        }),
      });
      if (response.ok) {
          ...
          <div className="space-y-4 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative flex items-center">
                      ...
                      readOnly 
                      className="h-10 sm:h-11 text-sm bg-gray-100 pr-12" 
                    />
            ...
            {currentStep === 3 && (
              <div className="space-y-4">
                ...
                {/* AI Questionnaire */}
                <div className="space-y-3">
                  <Label>AI-Powered Habit Recommendations</Label>
                  <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 p-4 rounded-lg border border-purple-200 dark:border-purple-700">
                    <div className="flex items-start space-x-3">
                      <div className="flex-shrink-0"><div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full flex items-center justify-center">
                        <i className="fas fa-robot text-white text-sm"></i></div></div>
                      <div className="flex-1">
                        ...
                        <Button
                          ...
                          className="bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white text-xs px-4 py-2"
                        >
                          <i className="fas fa-magic mr-2"></i> Start AI Questionnaire
                        </Button>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 p-3 sm:p-4 rounded-lg">
                  <h4 className="text-sm font-medium text-green-900 dark:text-green-100 mb-2">🎉 Almost Done!</h4>
                  <p className="text-xs sm:text-sm text-green-700 dark:text-green-300">Review your information and click "Create Account" to complete your signup.</p>
                </div>
              </div>
            )}
            {/* Actions */}
            <div className="flex flex-col sm:flex-row justify-between gap-3 pt-4 sm:pt-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                {currentStep < 3 ? (
                  ...
                  <Button type="button" onClick={handleSignupSubmit} disabled={loading} className="w-full sm:w-auto h-10 sm:h-11 text-sm bg-green-600 hover:bg-green-700 text-white">
