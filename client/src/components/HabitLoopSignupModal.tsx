...
const DIFFICULTY_OPTIONS = [
  {
    ...
    description: "Perfect for starting your habit journey",
  },
  {
    value: "medium",
    label: "Medium - Balanced challenge",
    description: "Great for consistent habit builders",
  },
  {
    value: "hard",
    label: "Hard - Advanced user",
    description: "For experienced habit masters",
  },
];
const GOAL_OPTIONS = [
...
export function HabitLoopSignupModal({
  ...
  const getCurrentAvatarUrl = () =>
    generateAvatarUrl(
      signupFormData.avatarStyle,
      signupFormData.avatarSeed,
      128
    );
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: `Welcome ${signupFormData.firstName}! Your account has been created.`,
        });
  ...
  const getStepTitle = () =>
    ["Basic Information", "Security Setup", "Personalization"][
      currentStep - 1
    ] || "Create New User";
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative flex items-center">
                      ...
                      />
                      <span
                        className="absolute right-3 text-xs py-1 px-2 rounded font-semibold bg-blue-100 text-blue-600 border border-blue-200"
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        handleInputChange("difficulty", v as any)
                      }
                    >
                      <SelectTrigger
                        id="difficulty"
                ...
                <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            <Input
                              ...
                              onChange={(e) =>
                                handleAvatarSeedChange(e.target.value)
                              }
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg">
                    <p className="text-xs text-blue-700 dark:text-blue-300">
                      💡 <strong>Tip:</strong> Change the seed text or click
                      dice to generate different avatars. The same seed always
                      creates the same avatar.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-3 sm:p-4 rounded-lg">
                  ...
                  <p className="text-xs sm:text-sm text-blue-700 dark:text-blue-300">
                    Your password will be securely hashed and stored. We
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {GOAL_OPTIONS.map((goal) => (
                      <Button
                        ...
                        type="button"
                        variant={
                          signupFormData.goals.includes(goal)
                            ? "default"
                            : "outline"
                        }
                        size="sm"
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-purple-700 dark:text-purple-300 mb-3">
                          Let our AI analyze your preferences and create custom
                          habits tailored to your lifestyle and goals.
                        </p>
                        <Button
                          type="button"
                        ...
                        >
                          <i className="fas fa-magic mr-2"></i> Start AI
                          Questionnaire
                        </Button>
                      </div>
                    </div>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 p-3 sm:p-4 rounded-lg">
                  ...
                  <p className="text-xs sm:text-sm text-green-700 dark:text-green-300">
                    Review your information and click "Create Account" to
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                {currentStep < 3 ? (
                  <Button
                    type="button"
                    onClick={handleNext}
                    className="w-full sm:w-auto h-10 sm:h-11 text-sm bg-blue-600 hover:bg-blue-700 text-white"
                  >
                    Next
                  </Button>
                ) : (
                  <Button
                    ...
                    disabled={loading}
                    className="w-full sm:w-auto h-10 sm:h-11 text-sm bg-green-600 hover:bg-green-700 text-white"
                  >
                    {loading ? (
      ...
      <AIQuestionnaireModal
        ...
        onClose={() => {
          ...
          toast({
            ...
            description:
              "Your personalized habits have been configured based on your preferences.",
          });
        }}
      />
    </>
