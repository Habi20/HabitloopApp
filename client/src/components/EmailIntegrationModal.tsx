...
import { Clock, TrendingUp, Brain, Calendar, CheckCircle, Send } from "lucide-react";
  ...
  const testEmailMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: "Check your inbox for the email report. Go to Settings to configure email notifications.",
        action: (
          <Button 
            variant="outline" 
            size="sm" 
